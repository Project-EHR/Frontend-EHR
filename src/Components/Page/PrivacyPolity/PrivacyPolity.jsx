...
export const PrivacyPolity = () => {
    return (
        <>
        <Header />
        <div className='polity-container'>
            <h1 className='polity-title'>POLÍTICA DE PRIVACIDAD</h1>
            <p className='polity-text'>El presente Política de Privacidad establece los términos en que Easy House Rent usa y protege la información que es
            ...
            <h2 className='polity-title'>Información que es recogida</h2>
            <p className='polity-text'>Nuestro sitio web podrá recoger información personal por ejemplo: Nombre, apellidos , correo electronico &nbsp;
                información de contacto como&nbsp; su dirección de correo electrónica e información demográfica. Así mismo cuando
                sea necesario podrá ser requerida información específica para procesar algún pedido o realizar una entrega o
                facturación.</p>
            <h2 className='polity-title'>Uso de la información recogida</h2>
            <p className='polity-text'>Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible, particularmente para
                ...
                cualquier momento.Easy House Rent está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos
                los sistemas más avanzados y los actualizamos constantemente para asegurarnos que no exista ningún acceso no
                autorizado.</p>
            <h3 className='polity-title'>Cookies</h3>
            <p className='polity-text'>Una cookie se refiere a un fichero que es enviado con la finalidad de solicitar permiso para almacenarse en su
            ...
            <p className='polity-text'>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su frecuencia. Esta
                ...
                menos de que usted así lo quiera y la proporcione directamente  Usted puede aceptar
            ...
            <h3 className='polity-title'>Enlaces a Terceros</h3>
            <p className='polity-text'>Este sitio web pudiera contener en laces a otros sitios que pudieran ser de su interés. Una vez que usted de clic en
                ...
                acuerdo con estas.</p>
            <h3 className='polity-title'>Control de su información personal</h3>
            <p className='polity-text'>En cualquier momento usted puede restringir la recopilación o el uso de la información personal que es proporcionada
                ...
                opción de recibir nuestro boletín o publicidad usted puede cancelarla en cualquier momento.Esta compañía no venderá, cederá ni distribuirá la información personal que es recopilada sin su consentimiento,
                salvo que sea requerido por un juez con un orden judicial.</p>
            <p className='polity-text'>Easy House Rent Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier
                momento.</p>
        </div>
        <Footer />
    </>
